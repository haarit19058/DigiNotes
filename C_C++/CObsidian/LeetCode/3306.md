## Hint
For every index r find the maximum leftmost index l such that both the conditions holds. TIme complexity (nlogn)
...
How would you use binary search in this case ??
